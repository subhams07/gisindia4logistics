"""
gis4logistics.cli
Command-line interface for GIS4Logistics India.
"""
...
def cmd_serve(args):
    ...
    import uvicorn
    print(f"Starting GIS4Logistics REST API Server on http://{args.host}:{args.port} ...")
...
def cmd_route(args):
    ...
    from gis4logistics.sdk import route_highway
    try:
...
def cmd_cost(args):
    ...
    from gis4logistics.sdk import calculate_freight_cost
...
def cmd_plot_villages(args):
    ...
    from gis4logistics.sdk import plot_villages
    res = plot_villages(
        state=args.state,
...
def main():
    parser = argparse.ArgumentParser(
        prog="gis4logistics",
        description="GIS4Logistics India — Open Geospatial & Freight Intelligence CLI"
    )
